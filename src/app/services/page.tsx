...
export const metadata: Metadata = {
  ...
  description:
    "Services digitaux BARANE INVEST: développement logiciel, transformation IT, automatisation des processus et marketing digital pour accélérer vos performances B2B.",
  openGraph: {
